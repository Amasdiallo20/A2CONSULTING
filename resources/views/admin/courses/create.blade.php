...
<div class="d-flex justify-content-between align-items-center mb-4">
    <h1><i class="fas fa-plus me-2"></i> Créer un cours</h1>
                ...
                <div class="col-md-4">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select @error('price_type') is-invalid @enderror" 
                            ...
                            <option value="free" {{ old('price_type') == 'free' ? 'selected' : '' }}>Gratuit</option>
                            <option value="paid" {{ old('price_type') == 'paid' ? 'selected' : '' }}>Payant</option>
                        </select>
                        @error('price_type')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('duration') is-invalid @enderror" 
                               id="duration" name="duration" value="{{ old('duration') }}" placeholder="ex: 10 heures">
                        @error('duration')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('lessons_count') is-invalid @enderror" 
                               id="lessons_count" name="lessons_count" value="{{ old('lessons_count', 0) }}" min="0">
                        @error('lessons_count')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control @error('quizzes_count') is-invalid @enderror" 
                               id="quizzes_count" name="quizzes_count" value="{{ old('quizzes_count', 0) }}" min="0">
                        @error('quizzes_count')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
